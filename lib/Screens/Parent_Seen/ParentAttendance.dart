...
import 'package:schooll/Screens/Parent_Seen/Marked.dart';
import 'package:schooll/Screens/Parent_Seen/ParentDetailCard.dart';
import 'package:schooll/Screens/Parent_Seen/Permeted.dart';
...
class _ParentAttendanceState extends State<ParentAttendance> with SingleTickerProviderStateMixin {
  @override
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: const TabBarView(
                      children: <Widget>[
                        ParentMarkedAttendance(),
                        ParentPermessionAttendance(),
                      ],
                    ),
                  ),
                ],
