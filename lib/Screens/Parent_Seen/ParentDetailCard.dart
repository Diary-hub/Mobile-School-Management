...
class ParentDetailCard extends StatefulWidget {
  const ParentDetailCard({Key? key}) : super(key: key);

  @override
  _ParentDetailCardState createState() => _ParentDetailCardState();
}

class _ParentDetailCardState extends State<ParentDetailCard> with SingleTickerProviderStateMixin {
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Obx(() {
                                      if (parentController.profileLoading.value == true) {
                                        return const ShimmerEffect(width: 80, height: 15);
                                      } else {
                                        return Text(
                                          parentController.parent.value.getFulltName,
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          "Email: ${parentController.parent.value.email}",
                                          style: const TextStyle(
                                            fontSize: 15,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.white,
                                        ...
                                        Text(
                                          "Students ID: ${parentController.parent.value.studentIDNumber}",
                                          style: const TextStyle(
                                            fontSize: 15,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.white,
