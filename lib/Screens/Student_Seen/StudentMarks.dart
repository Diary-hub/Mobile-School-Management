...
class MarksStudent extends StatelessWidget {
  const MarksStudent({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    subjects.fetchAllSubjectRecordByGrade(controller.student.value.grade);

    // subjects.fetchAllSubjectRecord();
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
            onPressed: () {
                      ...
                      child: ListTile(
                          ...
                          trailing: IconButton(
                            onPressed: () async {
                              ...
                              await controller.fetchStudentRecordBySubjectID(
                                  sub, AuthenticationRepository.instance.authUser!.uid);
                              showDialog(
                                context: context,
                                          ...
                                          const TableRow(
                                            children: [
                                              Padding(
                                                ...
                                                child: TableCell(child: Text('Subject')),
                                              ),
                                              Padding(
                                                padding: EdgeInsets.all(8.0),
                                          ...
                                          TableRow(
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: TableCell(
                                                    child:
                                                        Text(controller.finalExamController.text)),
                                              ),
                                            ],
                                          ),
                                        ],
