...
class StudentDetailCard extends StatefulWidget {
  const StudentDetailCard({Key? key}) : super(key: key);
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Obx(() {
                                      if (studentController.profileLoading.value == true) {
                                        return const ShimmerEffect(width: 80, height: 15);
                                      } else {
                                        return Text(
                                          studentController.student.value.getFulltName,
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          "Grade: ${studentController.student.value.grade}",
                                          style: const TextStyle(
                                            fontSize: 15,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.white,
                                        ...
                                        Text(
                                          "Students ID: ${studentController.student.value.idNumber}",
                                          style: const TextStyle(
                                            fontSize: 15,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.white,
