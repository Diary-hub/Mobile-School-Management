...
class StudentMarkedAttendance extends StatefulWidget {
  const StudentMarkedAttendance({Key? key}) : super(key: key);

  @override
  _StudentMarkedAttendanceState createState() => _StudentMarkedAttendanceState();
}

class _StudentMarkedAttendanceState extends State<StudentMarkedAttendance> {
